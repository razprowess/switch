...
export default function SearchResultList({ left }: SearchResultListProps) {
  return (
...
const StyledListItem = styled(ListItem)(({ theme }) => ({
  '&:hover': {
    backgroundColor: theme.palette.mode === LIGHT_MODE_THEME ? theme.palette.primary.light : theme.palette.secondary.contrastText,
    cursor: 'pointer',
    paddingRight: '10px',
